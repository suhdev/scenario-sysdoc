...
import { DecisionTreeCtrl } from './controllers/DecisionTree/DecisionTree';
...
(function () {
    ...
    ReactDOM.render(React.createElement(DecisionTreeCtrl, {store: store}), document.getElementById('SiteContainer'), () => {
        store.ready();
